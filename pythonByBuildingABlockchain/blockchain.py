...
open_transactions = []
# We are the owner of this blockchain node, hence this is our identifier (eg. Chandra)
owner = 'Chandra'
# registered participants: Ourself + other people sendind/ receiving coins
participants = {'Chandra'}


def hash_block(block):
    """Hashes a block and returns a string reepresentation of it.
...
def get_balance(participant):
    """Calculate and return the balance for a participation

    Arguments:
        :participent: The person for whom to calculate the balance
    """
    ...
    # This fetches received coin amounts of transactions that were already included in the blocks of the blockchain
    # We ignore open transactions here because you shouldn't be able to spend coins before the transaction was confirmed + included 
...
while waiting_for_input:
    ...
    if not verify_chain():
        ...
        break
    print('Balance of {}: {:6.2f}'.format('Chandra', get_balance('Chandra')))
else:
    print('User left!')
